...
import com.sandari.rain.libraries.typings.interfaces.ITokenization;
...
public class JwtTokenization implements ITokenization {
    ...
    @Override
    public String sign(ITokenizationPayload payload) {
    ...
    @Override
    public String refresh(ITokenizationPayload payload) {
        return this.sign(payload);
    }

    @Override
    public ITokenizationPayload getAllClaimsFromToken(String token) {
